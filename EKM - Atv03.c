...
//EKM - 10/05/2024
/*Solicitar uma data no formato DD/MM/AAAA, e calcular a quantidade de dias completos já decorridos desde o início desse ano
até essa data especificada (inclusive), a quantidade de dias que ainda faltam até o final do ano em questão e a quantidade total de dias do ano em questão (deve ser a soma das 2
